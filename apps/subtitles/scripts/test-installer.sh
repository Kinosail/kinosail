...
grep -Fq 'image: "${KINOSAIL_IMAGE:-ghcr.io/kinosail/kinosail-subtitles:latest}"' "$fixture/app/compose.release.yaml"
...
case "$*" in
  ...
  *"config --images"*) echo "ghcr.io/kinosail/kinosail-subtitles:latest" ;;
  *"image inspect"*) echo "ghcr.io/kinosail/kinosail-subtitles@sha256:${KINOSAIL_INSTALL_TEST_DIGEST:-aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa}" ;;
...
grep -Fq 'cosign verify --certificate-identity-regexp ^https://github\.com/Kinosail/kinosail/\.github/workflows/subtitles-release\.yml@refs/tags/subtitles-v(0|[1-9][0-9]*)\.(0|[1-9][0-9]*)\.(0|[1-9][0-9]*)$ --certificate-oidc-issuer https://token.actions.githubusercontent.com' "$fixture/compose.log"
