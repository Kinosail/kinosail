...
- Use Kinosail Subtitles and Kinosail Subtitles Server consistently.
...
- The supported self-hosted installation contains one Kinosail Subtitles Server container, plus a restricted public HTTPS gateway container when public viewing is enabled.
