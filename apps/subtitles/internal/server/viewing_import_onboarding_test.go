...
var onboardingFixture = servertest.OnboardingFixture{Library: libraryAPIFixture, Web: requestWithCookie, TOTP: testTOTP, Introduction: "Set up Subtitles", PlanLabel: "Subtitle plan"}
