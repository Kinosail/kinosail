...
var mcpReadRoutes = routeSet(
	"GET /api/v1", "GET /api/v1/openapi.json", "GET /api/v1/me", "GET /api/v1/library", "GET /api/v1/subtitle-library",
...
var mcpManageRoutes = routeSet(
	...
	"PUT /api/v1/items/{id}/metadata", "POST /api/v1/items/{id}/metadata/refresh", "POST /api/v1/items/{id}/subtitles",
...
var mcpBlockedRoutes = routeSet(
	...
	"GET /api/v1/devices", "GET /api/v1/downloads", "GET /api/v1/downloads/{id}", "GET /api/v1/downloads/{id}/file", "GET /api/v1/events", "GET /api/v1/media-shares", "GET /api/v1/passkeys",
	"GET /api/v1/me/oidc/link", "GET /api/v1/me/saml/link", "GET /api/v1/profiles",
	"GET /api/v1/session/oidc", "GET /api/v1/session/saml", "GET /api/v1/supporter", "GET /api/v1/supporter/certificates/{family}", "GET /api/v1/watch-rooms/{id}/events",
	"GET /api/v1/home-assistant", "GET /api/v1/home-assistant/library", "GET /api/v1/home-assistant/players",
	"POST /api/v1/api-keys", "POST /api/v1/items/{id}/downloads", "POST /api/v1/items/{id}/playback-events", "POST /api/v1/me/mfa/setup",
	...
	"POST /api/v1/media-shares", "POST /api/v1/media-shares/claim", "POST /api/v1/profiles", "POST /api/v1/quick-connect", "POST /api/v1/quick-connect/token", "POST /api/v1/quick-connect/{code}",
