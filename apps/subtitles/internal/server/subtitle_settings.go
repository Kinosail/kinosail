...
var subtitleSettingsView = newLocalizedTemplate("subtitle-settings", ignoreNonPasswordSecretAutofill(settingControlHTML+providerNeutralTrustedHTTPSPage(updateChoicePage(strings.NewReplacer(`/static/theme.js?v=electric-1`, `/static/theme.js?v=electric-1`, `/static/app.css?v=electric-1`, `/static/app.css?v=electric-1`).Replace(subtitleSettingsHTML)))))
