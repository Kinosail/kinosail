...
var (
	...
	setupCodeField            = `<label>Setup code<input name="setupCode" maxlength="128" autocomplete="one-time-code" autocapitalize="none" spellcheck="false" placeholder="Required from another device"><small>Use the one-time code shown in the Kinosail Server log. You can leave this blank on the Server.</small></label>`
