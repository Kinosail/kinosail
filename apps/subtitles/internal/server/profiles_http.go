...
var (
	setupUpdates              = `<details class="onboarding-disclosure wizard-update-disclosure"><summary>Update checks <span>Automatic by default</span></summary><fieldset class="wizard-update"><legend>Update checks</legend><label class="wizard-check"><input type="radio" name="updateMode" value="manual"><span><strong>Choose when to check</strong><small>Review signed updates yourself from Settings.</small></span></label><label class="wizard-check"><input type="radio" name="updateMode" value="automatic" checked><span><strong>Check automatically</strong><small>Kinosail checks about once a day and leaves installation under your control.</small></span></label></fieldset></details>`
	setupPage                 = strings.NewReplacer(`/static/app.css?v=electric-1`, `/static/app.css?v=electric-1`, `<aside class="wizard-rail">`, `<aside class="wizard-rail" aria-label="Setup progress">`, `<ol class="wizard-steps">`, `<ol class="wizard-steps" tabindex="0" aria-label="Setup steps">`, `<li class="is-current">`, `<li class="is-current" aria-current="step">`, `Create the Owner account to manage subtitle providers, media folders, and saved subtitle files.`, `Create the Owner account first. Choose media, language, and automation settings when you are ready.`, `Next: review media, language, and automation in Settings.`, `Next: secure your Owner account, then choose subtitle settings.`, `</p></aside><section class="wizard-stage">`, `</p>{{languagePicker}}</aside><section class="wizard-stage">`, `</main>{{languagePicker}}</body>`, `</main></body>`).Replace(setupHTML)
