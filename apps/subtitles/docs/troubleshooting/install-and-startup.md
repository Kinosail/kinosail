...
Open the exact configured address. A default local install uses `https://localhost:38128`. A local certificate can produce a browser trust warning. Accept it only when you know that you reached your own Server.
