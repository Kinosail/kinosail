...
| --- | --- | --- | --- | --- |
| `listen` | `KINOSAIL_LISTEN` | address | `127.0.0.1:38128` | yes |
...
| `subtitles.language` | `KINOSAIL_SUBTITLE_LANGUAGE` | lowercase ISO code | blank | no |
...
| `integrations.subdl.url` | `KINOSAIL_SUBDL_URL` | URL | blank | yes |
| `integrations.subdl.api_key` | `KINOSAIL_SUBDL_API_KEY` | secret text | blank | yes |
| `integrations.subsource.url` | `KINOSAIL_SUBSOURCE_URL` | URL | SubSource API | yes |
| `integrations.subsource.api_key` | `KINOSAIL_SUBSOURCE_API_KEY` | secret text | blank | yes |
| `integrations.subsource.personal_use` | `KINOSAIL_SUBSOURCE_PERSONAL_USE` | boolean | blank | yes |
| `integrations.opensubtitles.url` | `KINOSAIL_OPENSUBTITLES_URL` | URL | OpenSubtitles API | yes |
| `integrations.opensubtitles.api_key` | `KINOSAIL_OPENSUBTITLES_API_KEY` | secret text | blank | yes |
| `integrations.opensubtitles.username` | `KINOSAIL_OPENSUBTITLES_USERNAME` | secret text | blank | yes |
| `integrations.opensubtitles.password` | `KINOSAIL_OPENSUBTITLES_PASSWORD` | secret text | blank | yes |
