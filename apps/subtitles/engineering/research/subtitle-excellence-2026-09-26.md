...
| --- | --- | --- |
| A plausible VAD score damages an already correct track, or a default setting skips its quality guard | [Bazarr #3599](https://github.com/morpheus65535/bazarr/issues/3599), [#3608](https://github.com/morpheus65535/bazarr/issues/3608) | Compare the proposed transform with the original across independent regions. Reject implausible scale, offset, and local regressions. Make the guard unconditional. Keep the original. |
