...
<details><summary>Is Kinosail Server free?</summary><p>Yes. Kinosail Server is free to run on your own hardware, and the web Player is included. You can also connect a compatible Jellyfin mobile app after enabling Jellyfin support over trusted HTTPS.</p></details>
