...
<details><summary>Can I try Kinosail with the media I already have?</summary><p>Yes. Kinosail scans your existing media folder through a read-only mount, so your original files stay in place. <a href="{{ '/quickstart/' | relative_url }}">Install with Docker</a>, then <a href="{{ '/getting-started/add-media/' | relative_url }}">add a Library</a>.</p></details>
...
<p><a class="text-link" href="{{ '/faq/' | relative_url }}">Read all frequently asked questions <span aria-hidden="true">↗</span></a></p>
</section>
