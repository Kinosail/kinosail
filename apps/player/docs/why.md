...
<p>Player runs on your hardware and uses your existing media folders. Original media is mounted read-only. Local use doesn’t need a Kinosail-hosted account. Optional services and remote access have their own boundaries, explained in the <a href="{{ '/reference/architecture-and-privacy/' | relative_url }}">architecture and privacy guide</a>.</p>
