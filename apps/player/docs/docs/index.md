...
description: Install Kinosail Player with Docker, add your media, and start watching in your browser.
hide_contribute: true
---
# Your media. At home in your browser.

Run Kinosail Player on your own hardware. Bring your movies, shows, music, books, and photos together, then enjoy them from your web browser.
