...
- [Connect browsers and Jellyfin apps]({{ '/getting-started/connect-devices/' | relative_url }}) to use secure local access or required trusted HTTPS for Jellyfin apps.
