...
image="${KINOSAIL_TEST_IMAGE:-localhost/kinosail:dev}"
if [[ -z "$engine" ]]; then
...
EOF
cat >"$output/Movies/Example Movie.en.vtt" <<'EOF'
WEBVTT

00:00:00.000 --> 00:00:03.000
Example English subtitle fixture.
EOF
cat >"$output/Movies/Example Movie.es.vtt" <<'EOF'
WEBVTT

00:00:00.000 --> 00:00:03.000
Ejemplo de subtitulo en espanol.
EOF
