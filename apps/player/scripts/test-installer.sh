...
grep -Fq 'cosign verify --certificate-identity-regexp ^https://github\.com/Kinosail/kinosail/\.github/workflows/player-release\.yml@refs/tags/player-v(0|[1-9][0-9]*)\.(0|[1-9][0-9]*)\.(0|[1-9][0-9]*)$ --certificate-oidc-issuer https://token.actions.githubusercontent.com' "$fixture/compose.log"
