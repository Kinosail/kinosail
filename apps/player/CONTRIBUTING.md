# Contributing to Kinosail Player
...
Clone the full monorepo and work in `apps/player/`. The shared `packages/` module and repository-root container context are required. The [app README](README.md) covers local setup; [engineering](engineering/README.md) contains architecture and release guidance.
