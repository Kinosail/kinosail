...
func configurationSchema() configurationcore.Schema {
	...
	return configurationcore.Schema{Fields: fields, Retired: retiredConfigurationKey, Validate: validateConfigurationValue}
}
...
func validateConfiguredSnapshot(configured Snapshot) error {
	...
	validators := []func(Snapshot) error{configurationcore.ValidateMCP[Snapshot], validateRemoteAccess, validateSCIM, validateFederatedOIDC, validateFederatedSAML, validateTrustedHTTPS, validateJellyfinCompatibility, validateSupporter}
