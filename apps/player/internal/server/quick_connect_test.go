...
func TestQuickConnectPageUsesSixDigitAutoSubmitControl(t *testing.T) {
	...
	for _, expected := range []string{`/static/app.css?v=electric-28`, `/static/quick-connect.js?v=1`, `data-quick-connect-digit`, `maxlength="1"`, `inputmode="numeric"`, `pattern="[0-9]"`, `aria-label="Digit 6 of 6"`, "six-digit code"} {
