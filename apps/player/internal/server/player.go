...
func playerTemplate(template string) string {
	template = strings.Replace(template, `/static/downloads.js?v=3`, `/static/downloads.js?v=28`, 1)
	...
	template = strings.Replace(template, `/static/player.js?v=34`, `/static/player.js?v=79`, 1)
