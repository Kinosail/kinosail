...
func TestPublicOutboundResolutionRejectsMixedAndEmptyAnswers(t *testing.T) {
	servertest.PublicOutboundResolutionRejectsMixedAndEmptyAnswers(t, allowedOutboundIP)
}
...
func TestSessionTimeoutValidationHasNoSideEffects(t *testing.T) {
	...
	servertest.SessionTimeoutValidationHasNoSideEffects(t, store.sessionTimeouts, store.setSessionTimeouts)
}
