...
var publicRoutes = map[string]routeAccess{
	...
	"GET /cast/{id}/subtitles/{track}": capabilityRoute, "OPTIONS /cast/{id}/subtitles/{track}": capabilityRoute,
	"GET /cast/{id}/media": capabilityRoute, "GET /cast/{id}/hls/{file...}": capabilityRoute,
	"OPTIONS /cast/{id}/media": capabilityRoute, "OPTIONS /cast/{id}/hls/{file...}": capabilityRoute,
	...
	"GET /static/main.kinosail.bundle.js": publicRoute, "GET /static/theme.js": publicRoute, "GET /static/quick-connect.js": publicRoute, "GET /static/connect.js": publicRoute, "GET /static/app.css": publicRoute, "GET /static/supporter.js": publicRoute, "GET /static/supporter.css": publicRoute, "GET /static/manrope.woff2": publicRoute, "GET /static/icon.svg": publicRoute,
	"GET /static/supporter/badges/{file...}": publicRoute,
	...
	"GET /connect":               publicRoute,
	"POST /api/v1/quick-connect": publicRoute, "POST /api/v1/quick-connect/token": publicRoute, "POST /api/v1/quick-connect/cancel": publicRoute,
...
func remotePublicRouteDenied(pattern string) bool {
	...
	case "GET /healthz", "GET /setup", "POST /setup", "POST /api/v1/setup", "POST /mcp", "GET /mcp", "DELETE /mcp",
		...
		"GET /connect", "GET /api/v1/quick-connect/pending", "GET /api/v1/quick-connect/{code}", "POST /api/v1/quick-connect/{code}", "POST /QuickConnect/Authorize", "GET /Items/{id}/Images/{type}", "GET /Items/{id}/Images/{type}/{index}", "GET /dlna/{token}/device.xml", "GET /dlna/{token}/content.xml", "POST /dlna/{token}/content", "GET /dlna/{token}/media/{id}", "HEAD /dlna/{token}/media/{id}":
		return true
	}
	return false
}
