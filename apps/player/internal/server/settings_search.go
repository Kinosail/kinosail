...
func addSettingsSearch(page string) string {
	search := `<section class="settings-search" data-settings-search aria-labelledby="settings-search-title"><h2 id="settings-search-title">Find a setting</h2><label for="settings-search-input">Search settings</label><input id="settings-search-input" data-settings-search-input type="search" maxlength="160" autocomplete="off" autocapitalize="none" spellcheck="false" placeholder="Search Basic &amp; Advanced…" aria-describedby="settings-search-help" aria-keyshortcuts="/"><p id="settings-search-help">Search by name or task. Try “subtitles” or “remote access”.</p><output data-settings-search-status aria-live="polite"></output><div class="settings-search-results" data-settings-search-results hidden></div></section>`
