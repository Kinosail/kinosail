...
func trustedHTTPSFixture() servertest.TrustedHTTPSFixture {
	fixture := servertest.TrustedHTTPSFixture{Origin: configuration.TrustedOrigin, SignIn: signInTestProfile, Web: requestWithCookie, Token: trustedHTTPSTestToken, ExpectedOrigin: "https://family-media.duckdns.org:38127"}
