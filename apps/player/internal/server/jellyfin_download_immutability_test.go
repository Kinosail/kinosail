...
func TestJellyfinDownloadResumesConditionallyAcrossReplacementAndRestart(t *testing.T) { //nolint:cyclop // One compatibility test covers conditional resumes across file replacement and restart.
	t.Parallel()
