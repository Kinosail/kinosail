...
func TestLastLightHomeUsesRealLibraryArtwork(t *testing.T) {
	...
	for _, fragment := range []string{`class="home-feature"`, `class="watch-progress"`, `aria-label="Watch progress"`, `data-feature-title="Arrival"`, `class="app-header"`, `Recently added`, `/static/app.css?v=electric-29`} {
