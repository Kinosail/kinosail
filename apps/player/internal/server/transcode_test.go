...
func transcodeFixture() servertest.TranscodeFixture {
	...
	}, WriteExecutable: writeExecutable, AssertSafari: assertSafariDefersMatroska, PlayableHLS: fakePlayableHLS(), PlayerScript: "/static/player.js?v=78"}
}
...
func TestAdaptiveHLSPublishesACompleteTruthfulLadder(t *testing.T) {
	transcodeFixture().AdaptiveHLSPublishesACompleteTruthfulLadder(t, "2", "-hls_segment_options movflags=+frag_discont+skip_sidx")
}
