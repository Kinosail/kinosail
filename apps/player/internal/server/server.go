...
{{if .TMDB}}<footer><a href="https://www.themoviedb.org">TMDB</a> · This product uses the TMDB API but is not endorsed or certified by TMDB.</footer>{{end}}</main>{{languagePicker}}<script src="/static/supporter.js?v=15"></script></body></html>
