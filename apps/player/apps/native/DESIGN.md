...
The Apple Watch remote keeps the current title, player, progress and primary play action visible first. Electric green marks play and the movie-time heart graph. Heart tracking begins only when the viewer taps Start heart graph and grants Health access; missing readings or playback positions appear as gaps. The watch reads Health locally and does not send heart data to the iPhone, Apple TV or Server.
