...
The scanner list is in [library.go](../../../../packages/library/library.go). Subtitle discovery is in [scan.go](../../../../packages/library/scan.go). Playback decisions are in [playback_plan.go](../../internal/server/playback_plan.go). Reader behavior is in [reader.go](../../internal/server/reader.go).
