...
- Kinosail returns `"ProductName": "Kinosail Server"` in its [compatibility response](../../internal/server/jellyfin.go). This preserves independent product identity but can fail current client identity checks.
