...
This remains compatible with Kinosail's one-container boundary. The Home Assistant component runs inside Home Assistant. It is not a Kinosail sidecar ([Kinosail API-container ADR](../../../apps/player/engineering/adr/0005-expose-complete-api-from-one-server-container.md)).
...
See the current route and scope definitions in [`api_keys.go`](../../../apps/player/internal/server/api_keys.go), [`api_product.go`](../../../apps/player/internal/server/api_product.go), [`api_browse.go`](../../../apps/player/internal/server/api.go), and [`api_media.go`](../../../apps/player/internal/server/api_media.go).
...
The existing Watch Together socket is room-specific. It is not a server-wide device event interface. Kinosail explicitly does not support Jellyfin WebSocket remote-session control today ([compatibility matrix](../../../apps/player/docs/reference/media-compatibility.md)).
...
Kinosail implements password and Quick Connect login, item browsing, playback information, streaming, and progress calls. It does not implement `GET /Sessions`. It accepts capability reports, but it has no compatible remote-session command surface. See [`jellyfin.go`](../../../apps/player/internal/server/jellyfin.go) and [`jellyfin_playback.go`](../../../apps/player/internal/server/jellyfin_playback.go).
...
- [`README.md`](../../../apps/player/README.md)
- [`DESIGN.md`](../../../apps/player/DESIGN.md)
- [`docs/compatibility.md`](../../../apps/player/docs/reference/media-compatibility.md)
- [`docs/adr/0005-expose-complete-api-from-one-server-container.md`](../../../apps/player/engineering/adr/0005-expose-complete-api-from-one-server-container.md)
- [`internal/server/api_keys.go`](../../../apps/player/internal/server/api_keys.go)
- [`internal/server/api_product.go`](../../../apps/player/internal/server/api_product.go)
- [`internal/server/api_browse.go`](../../../apps/player/internal/server/api.go)
- [`internal/server/api_media.go`](../../../apps/player/internal/server/api_media.go)
- [`internal/server/jellyfin.go`](../../../apps/player/internal/server/jellyfin.go)
- [`internal/server/jellyfin_playback.go`](../../../apps/player/internal/server/jellyfin_playback.go)
