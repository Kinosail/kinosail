...
When HTML materially improves the review, render it as one self-contained file in the OS temp directory. Use local CSS and inline SVG. Use Mermaid only when the repository already provides it locally.
...
<html lang="en">
  <head>
    ...
    <style>
      /* Keep all report styling local and focused. */
