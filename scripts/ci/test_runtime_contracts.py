...
class RuntimeContracts(unittest.TestCase):
    ...
    def test_promotion_preserves_pending_jobs_and_verifies_consumer_identity(self):
        ...
        self.assertIn("cosign-release: 'v3.1.3'", source)
        self.assertIn('DOCKER_CONFIG="$anonymous_docker_config" cosign verify', source)
        self.assertIn('for attempt in {1..24}; do', source)
        ...
        self.assertIn("cosign-release: 'v3.1.3'", release)
